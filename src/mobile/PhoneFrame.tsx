...
export function PhoneFrame({ children }: PropsWithChildren) {
  ...
  const scale = useDeviceScale(geometry.device.height, geometry.device.width);
    ...
    <ScreenPortalContext.Provider value={contextValue}>
      <div className="phone-stage">
        ...
        <div
          ...
          style={{
            width: geometry.device.height * scale,
            height: geometry.device.width * scale,
          }}
        >
          <div
            ...
            style={{
              ...
              left: 0,
              top: geometry.device.width * scale,
